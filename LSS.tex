...
\subsubsection{Model matematyczny}
W przyjętym modelu D2Q9 metody siatek Boltzmanna proces kolizji ma następującą postać:
\begin{equation}
f_{i}(x + \Delta x, t + \Delta t) = f_{i}(x,t) - \frac{1}{\tau_f}[f_{i}(x,t) - f_{i}^{eq}(x,t)] + \Delta f_{i}(x,t).
\end{equation}
...
\end{equation}
Gdy na cząsteczki działa zewnętrzna siła $F$, to makroskopowa prędkość płynu wyraża się następująco:
\begin{equation}
