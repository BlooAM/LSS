...
\label{LSS_v12}
\end{equation}
zaś \textbf{W} oraz \textbf{H} są macierzami zerowymi. Wspominamy, że macierz układu () ma tę samą postać w przypadku tzw. \textit{metody tangent}, wobec czego dalsze uwagi będą dotyczyły obu metod.
