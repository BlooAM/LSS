...
\label{LSS_v17}
\end{equation}
gdzie para indeksów oznacza macierz kwadratową, której wymiar jest równy wymiarowi punktu przestrzeni fazowej (w kontekście numerycznej mechaniki płynów jest on proporcjonalny do wymiarów siatki obliczeniowej). Pozostałe bloki to macierze zerowe.
\begin{equation}
