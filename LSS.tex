...
\subsection{LSS - analiza zbieżności}
\newpage
...
\begin{figure}[H]
	...
	\caption{Najlepiej dopasowana parabola na tle krzywej funkcji celu}
\end{figure}
Kolejną charakterystyką jest średni skumulowany spadek ciśnienia (tj. średni spadek ciśnienia liczony od początku do danej chwili), którego wykres dla pierwszych $ T = 100 $  kroków czasowych oraz dla parametru wlotowego $ u=0.1 $ przedstawia Rysunek.
\begin{figure}[H]
	\includegraphics[scale=0.7]{figures/mean_dp_100.png} 
	\centering
	\caption{Skumulowany średni spadek ciśnienia}
\end{figure}
