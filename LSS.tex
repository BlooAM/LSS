...
Podsumowując powyższe podsumowania można stwierdzić, iż pierwsze pojawienie się bifurkacji ($ r=1 $) pozwoliło na 'kotrolowaną' zmianę jakościową rozwiązań rozważanego równania. Kolejne bifurkacje (poczynając od $ r=3 $) pojawiające się z coraz większą częstotliwością doprowadziły do chaosu poprzez tzw. \textit{podwajanie okresu}. 
