...
\end{equation}
Z powyższych wzorów wnioskujemy, iż postać równania Tangent w Metodzie Trajektorii Cienia zawiera dodatkowy człon związany z dylatacją czasu w stosunku do (\ref{J_tangent}). Cała idea tkwi w odpowiednim rozwiązaniu $ \{v_{i}\}_{i=1,...,m} $, który nazywamy \textit{kierunkiem cienia}.
\begin{equation}
